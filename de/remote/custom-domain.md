...
Das setzt voraus, dass du den Server bereits unter dieser Adresse erreichbar gemacht hast, über dein eigenes DNS und einen Reverse-Proxy oder Port-Forwarding an deinem Router. camera.ui ändert hier nichts an deinem Netzwerk; es merkt sich die zu verwendende öffentliche Adresse. Wenn du den Weg über einen Reverse-Proxy gehst, beschreibt [Reverse-Proxy](/de/remote/reverse-proxy), was der Proxy weiterleiten muss.
