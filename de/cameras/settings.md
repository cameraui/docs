...
- **Allgemein.** Name, Raum, Kameratyp und ob die Kamera deaktiviert ist (hier entfernst du auch eine Kamera). Der Raum wird aus den vorhandenen gewählt oder hier angelegt. Der Löschen-Knopf daneben entfernt den gewählten Raum: seine Kameras wechseln nach Default und er verschwindet aus dem Grundriss, Default selbst bleibt; er gruppiert die [Startseite](/de/cameras/home) und ist der Raum, in dem die Kamera im [Grundriss](/de/cameras/floor-plan) steht. Wechselt die Kamera hier in einen anderen Raum, verschwindet sie aus dem Grundriss, weil ihr Platz im neuen Raum unbekannt ist: zieh sie im Grundriss wieder in diesen Raum.
...
- **Snapshot.** Wann die Kamera ein neues Standbild macht: regelmäßig, beim Ansehen oder nur auf Anfrage. Siehe [Snapshots und wie sie sich aktualisieren](/de/cameras/home#snapshots-und-wie-sie-sich-aktualisieren).
