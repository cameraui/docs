...
- **NVIDIA:** der normale Treiber (z.B. `sudo ubuntu-drivers install`); das Container Toolkit ist Docker-spezifisch, hier nicht nötig. Für CUDA-Erkennung mit dem ONNX-Plugin müssen zusätzlich die CUDA-13-Bibliotheken und cuDNN 9 aufs System ([NVIDIA-apt-Repo](https://developer.nvidia.com/cuda-downloads): `sudo apt install cuda-libraries-13-2 cudnn9-cuda-13`); das ONNX-Legacy-Plugin will stattdessen CUDA 12. Die Docker-Images bringen beides mit, Bare-Metal nicht
