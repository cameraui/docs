...
**Kandidaten auswählen** in der schwebenden Button-Gruppe in der Ecke startet die Auswahl, dann hakst du die bestätigten Frames an und reichst sie über den Wolken-Button ein. Der Upload läuft im Hintergrund, ein Banner zeigt den Fortschritt, und jeder eingereichte Frame verschwindet aus der lokalen Liste. Zum Einreichen muss dein Server bei der [camera.ui Cloud](/de/remote/cloud) angemeldet sein.
